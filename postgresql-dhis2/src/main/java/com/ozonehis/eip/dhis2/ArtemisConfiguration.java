...
/**
 * Configuration for Apache ActiveMQ Artemis JMS connectivity. Sets up the connection factory for
 * Camel JMS routes and Dead Letter Queue.
 */
@Configuration
public class ArtemisConfiguration {
  ...
  /**
   * Create and configure the Artemis connection factory bean. This factory is used by Camel JMS
   * routes for Dead Letter Queue operations.
   *
